...
class Pdf(_message.Message):
    __slots__ = ("id", "name", "page_count", "created_at", "updated_at", "file_size", "batch_count", "vector_chunk_count", "tags", "content")
    ...
    content: str
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., page_count: _Optional[int] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., file_size: _Optional[int] = ..., batch_count: _Optional[int] = ..., vector_chunk_count: _Optional[int] = ..., tags: _Optional[_Iterable[_Union[_tag_pb2.Tag, _Mapping]]] = ..., content: _Optional[str] = ...) -> None: ...

class PdfListItem(_message.Message):
    __slots__ = ("id", "name", "page_count", "created_at", "updated_at", "file_size", "batch_count", "vector_chunk_count", "tags")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    PAGE_COUNT_FIELD_NUMBER: _ClassVar[int]
    CREATED_AT_FIELD_NUMBER: _ClassVar[int]
