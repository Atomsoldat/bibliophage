...
class SearchPdfsRequest(_message.Message):
    __slots__ = ("title_query", "system_filters", "type_filter", "tag_filters", "page_size", "page_number", "sort_order")
    ...
    def __init__(self, title_query: _Optional[str] = ..., system_filters: _Optional[_Iterable[str]] = ..., type_filter: _Optional[str] = ..., tag_filters: _Optional[_Iterable[_Union[_common_pb2.TagFilter, _Mapping]]] = ..., page_size: _Optional[int] = ..., page_number: _Optional[int] = ..., sort_order: _Optional[_Union[_common_pb2.SortOrder, str]] = ...) -> None: ...
