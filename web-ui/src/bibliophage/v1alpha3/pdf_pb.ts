 ...
 *
 * @generated from message bibliophage.v1alpha3.SearchPdfsRequest
 */
export class SearchPdfsRequest extends Message<SearchPdfsRequest> {
  ...
  /**
   * Filter by systems (returns PDFs where systems array contains ANY of these values)
   * Example: ["Call of Cthulhu", "Pathfinder 1e", "Generic"] returns CoC + Pathfinder + generic PDFs
   *
   * @generated from field: repeated string system_filters = 2;
   */
   ...
   * Sorting
   *
   * @generated from field: optional bibliophage.v1alpha3.SortOrder sort_order = 7;
   */
  sortOrder?: SortOrder;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bibliophage.v1alpha3.SearchPdfsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "title_query", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 2, name: "system_filters", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    ...
    { no: 7, name: "sort_order", kind: "enum", T: proto3.getEnumType(SortOrder), opt: true },
  ]);
 ...
 *
 * @generated from message bibliophage.v1alpha3.SearchPdfsResponse
 */
export class SearchPdfsResponse extends Message<SearchPdfsResponse> {
   ...
   *
   * @generated from field: repeated bibliophage.v1alpha3.PdfListItem pdfs = 3;
   */
  pdfs: PdfListItem[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bibliophage.v1alpha3.SearchPdfsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "success", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "message", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message bibliophage.v1alpha3.GetPdfRequest
 */
export class GetPdfRequest extends Message<GetPdfRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bibliophage.v1alpha3.GetPdfRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
 ...
 *
 * @generated from message bibliophage.v1alpha3.GetPdfResponse
 */
export class GetPdfResponse extends Message<GetPdfResponse> {
   ...
   *
   * @generated from field: optional bibliophage.v1alpha3.Pdf pdf = 3;
   */
  pdf?: Pdf;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bibliophage.v1alpha3.GetPdfResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "success", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "message", kind: "scalar", T: 9 /* ScalarType.STRING */ },
